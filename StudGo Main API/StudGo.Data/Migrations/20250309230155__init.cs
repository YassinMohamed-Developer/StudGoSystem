        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentActivities_AspNetUsers_AppUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AgendaUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsOpened = table.Column<bool>(type: "bit", nullable: false),
                    NumberOfSeats = table.Column<int>(type: "int", nullable: false),
                    ActivityType = table.Column<int>(type: "int", nullable: false),
                    StudentActivityId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "StudentStudentActivity",
                columns: table => new
                {
                    StudentActivitiesId = table.Column<int>(type: "int", nullable: false),
                    StudentsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentStudentActivity", x => new { x.StudentActivitiesId, x.StudentsId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Activities_StudentActivityId",
                table: "Activities",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contents_ActivityId",
                table: "Contents",
                column: "ActivityId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentActivities_AppUserId",
